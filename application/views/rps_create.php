...
<body class="bg-primary">
    ...
    <div class="container d-md-flex position-absolute top-50 start-50 translate-middle justify-content-center mt-4">
        <div class="card mb-3 w-50">
            <div class="card-body">
            <h4 class="card-title pt-2 pb-2 text-center"><strong>Form Tambah RPS</strong></h4>
            <hr>
            <?php echo form_open('rps/create'); ?>
            <div class="row">
                <div class="mb-3 col-6">
                    <label for="nomor_rps" class="form-label">Nomor RPS:</label>
                    <input type="text" name="nomor_rps" class="form-control" required>
                </div>
                <div class="mb-3 col-6">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="text" name="nik_dosen" class="form-control" required>
                </div>
                <div class="mb-3 col-6">
                ...
                <div class="d-flex justify-content-center">
                    <a href="<?php echo base_url('index.php/rps'); ?>" class="btn btn-danger me-2">batal</a>
